...
def parse_opts():
    ...
    parser.add_argument(
        '--data_path_linux',
        default='/data/pg-umcg_mii/pfs_prediction/data/VolPatch_clinical',
        type=str,
        help='Data directory path')
    parser.add_argument(
        '--save_stats', 
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help='Which outcome is applied for forware fearure selection')
    ...
    parser.add_argument(
        ...
        default=3,
        type=int,
        help='Different types of inputs (0 for only CT, 1 for masking CT and 2 for CT and mask are in two channels)')  #
    parser.add_argument(
        '--input_modality',
        default=0,
        type=int,
        help='Different types of input modality (0 for only CT, 1 for only PET, 2 for CT and PET in two channels)')  #
    parser.add_argument(
        '--fold',
        default=1,
        type=int,
