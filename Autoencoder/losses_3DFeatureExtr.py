...
class CombinedLoss(nn.Module):
    ...
    def forward(self, **kwargs):
        ...
        adv_loss = nn.MSELoss()(kwargs['logits'], kwargs['labels'])
        ...
        return {'loss': loss, 'L1': l1_loss, 'SSIM': ssim_loss, 'SSIM_piqa': ssim_piqa_loss, 'MSE': mse_loss, 'KLD': kld_weight * kld_loss, 'ADV':0.1*adv_loss, 'DICE':dice_loss}  # -kld_loss}
