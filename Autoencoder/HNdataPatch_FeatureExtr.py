...
class dataset_volpatch(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt.input_type == 0:
            ...
            volinput2[0:VolInput.shape[0],36-int(volinput.shape[1]/2):36-int(volinput.shape[1]/2)+volinput.shape[1],72-int(volinput.shape[2]/2):72-int(volinput.shape[2]/2)+volinput.shape[2],72-int(volinput.shape[3]/2):72-int(volinput.shape[3]/2)+volinput.shape[3]] = volinput
            volinput2 = volinput2[0:VolInput.shape[0],36-16:36+16,72-32:72+32,72-32:72+32]
